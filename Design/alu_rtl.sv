module ALU_DESIGN #(parameter DW = 8, CW = 4)(INP_VALID,OPA,OPB,CIN,CLK,RST,CMD,CE,MODE,COUT,OFLOW,RES,G,E,L,ERR);
  ...
  input [CW-1:0] CMD;
  input [1:0] INP_VALID;
  output reg [DW*2-1:0] RES = {(DW*2){1'b0}};
      ...
      4'b0001 :                begin
	   ...
	   4'b1001: begin   
        ...
        begin 
           ...
           ERR=1'b0;
           case(CMD_tmp)    
             4'b0000:RES={{DW{1'b0}},oprd1&oprd2};     
             4'b0001:RES={{DW{1'b0}},~(oprd1&oprd2)};  
             4'b0010:RES={{DW{1'b0}},oprd1&&oprd2};     
             4'b0011:RES={{DW{1'b0}},~(oprd1|oprd2)};  
             4'b0100:RES={{DW{1'b0}},oprd1^oprd2};     
             4'b0101:RES={{DW{1'b0}},~(oprd1^oprd2)};  
             4'b0110:RES={{DW{1'b0}},~oprd1};        
             4'b0111:RES={{DW{1'b0}},~oprd2};        
             4'b1000:RES={{DW{1'b0}},oprd1};      
             4'b1001:RES={{DW{1'b0}},oprd1<<1};      
             4'b1010:RES={{DW{1'b0}},oprd2<<1};      
             4'b1011:RES={{DW{1'b0}},oprd2<<1};     
             4'b1100:                        
             begin
               if(oprd2[0])
